...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        add(c2);
        c3 = new JCheckBox("Monile Banking");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (c1.isSelected()) {
            ...
            facality = facality + "Email & SMS Alerts";
        ...
        try {
            if (ae.getSource() == submit) {
                if (accountType.equals("")) {
                    ...
                    conn c = new conn();
                    String querry1 = "insert into signupthree values('" + formno + "','" + accountType + "','"
                            + cardnumber + "','" + pinnumber + "','" + facality + "')";
